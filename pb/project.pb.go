...
var file_project_proto_rawDesc = []byte{
	...
	0x06, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x73, 0x32, 0xcc, 0x06, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x6a,
...
var file_project_proto_depIdxs = []int32{
	...
	9,  // 12: project.ProjectService.CreateGig:output_type -> google.protobuf.Empty
	9,  // 13: project.ProjectService.UpdateGig:output_type -> google.protobuf.Empty
	1,  // 14: project.ProjectService.GetGig:output_type -> project.GigResponse
	1,  // 15: project.ProjectService.GetAllFreelancerGigs:output_type -> project.GigResponse
	9,  // 16: project.ProjectService.AddPackageType:output_type -> google.protobuf.Empty
	9,  // 17: project.ProjectService.EditPackageType:output_type -> google.protobuf.Empty
	5,  // 18: project.ProjectService.GetPackageType:output_type -> project.PackageTypeResponse
	9,  // 19: project.ProjectService.ClientAddRequest:output_type -> google.protobuf.Empty
	9,  // 20: project.ProjectService.ClientUpdateRequest:output_type -> google.protobuf.Empty
	8,  // 21: project.ProjectService.GetClientRequest:output_type -> project.ClientRequestResponse
	8,  // 22: project.ProjectService.GetAllClientRequest:output_type -> project.ClientRequestResponse
	1,  // 23: project.ProjectService.GetAllGigs:output_type -> project.GigResponse
