...
type SearchServiceClient interface {
	...
	GetReview(ctx context.Context, in *ReviewById, opts ...grpc.CallOption) (SearchService_GetReviewClient, error)
...
func (c *searchServiceClient) UserAddReview(ctx context.Context, in *UserReviewRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/search.SearchService/UserAddReview", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searchServiceClient) GetReview(ctx context.Context, in *ReviewById, opts ...grpc.CallOption) (SearchService_GetReviewClient, error) {
	stream, err := c.cc.NewStream(ctx, &SearchService_ServiceDesc.Streams[0], "/search.SearchService/GetReview", opts...)
	if err != nil {
		return nil, err
	}
	x := &searchServiceGetReviewClient{stream}
...
type SearchService_GetReviewClient interface {
	Recv() (*ReviewResponse, error)
	grpc.ClientStream
}

type searchServiceGetReviewClient struct {
	grpc.ClientStream
}

func (x *searchServiceGetReviewClient) Recv() (*ReviewResponse, error) {
...
func (c *searchServiceClient) RemoveReview(ctx context.Context, in *UserReviewRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/search.SearchService/RemoveReview", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SearchServiceServer interface {
	...
	GetReview(*ReviewById, SearchService_GetReviewServer) error
...
func (UnimplementedSearchServiceServer) GetReview(*ReviewById, SearchService_GetReviewServer) error {
	return status.Errorf(codes.Unimplemented, "method GetReview not implemented")
}
...
func _SearchService_UserAddReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/search.SearchService/UserAddReview",
	}
...
func _SearchService_GetReview_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ReviewById)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(SearchServiceServer).GetReview(m, &searchServiceGetReviewServer{stream})
}

type SearchService_GetReviewServer interface {
	Send(*ReviewResponse) error
	grpc.ServerStream
}

type searchServiceGetReviewServer struct {
	grpc.ServerStream
}

func (x *searchServiceGetReviewServer) Send(m *ReviewResponse) error {
...
func _SearchService_RemoveReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/search.SearchService/RemoveReview",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var SearchService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "GetReview",
			Handler:       _SearchService_GetReview_Handler,
			ServerStreams: true,
		},
	},
